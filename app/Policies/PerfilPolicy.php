...
class PerfilPolicy
{
	...
	{
		// verificamos si el usuario logueado es el mismo que el perfil que se quiere ver
	...
	{
		// verificamos si el usuario logueado es el mismo que el perfil que se quiere editar
		return $user->id === $perfil->user_id;
	}
